...
public class CreateTopicAndPublishMessages {
    ...
    public static void publishMessages(String projectId, String topicId, String publishmessage) throws Exception {
        ...
        try {
            ...
            List<String> messages = Arrays.asList(publishmessage);
    ...
    public static void publishMessagesWithErrorHandler(String projectId, String topicId, String publishmessage) throws Exception {
